...
import { getReservationForCheck, saveCheckin } from "@/lib/checkinout";
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
            📋 Check-in - État des lieux d'entrée
          </h1>
          <p className="text-gray-600">
            Prenez des photos du véhicule avant de démarrer la location
          </p>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              rows={3}
              placeholder="Ex: Petite rayure sur le pare-choc avant..."
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
            />
          </div>
        </div>
